...
comunidades <- unique(df_Turismo_Ocupacion$Comunidades.y.Ciudades.Autónomas)
...
for (com in comunidades) {
  ...
  datos_com <- df_Turismo_Ocupacion %>%
    filter(Comunidades.y.Ciudades.Autónomas == com)
...
correlaciones_por_comunidad <- df_Turismo_Ocupacion %>%
  ...
  select(Comunidades.y.Ciudades.Autónomas, correlacion, p_value) %>%
