...
\AuthorNames{Iyán Álvarez, Azahara Martínez, Juan Alcaraz Otón, }
...
\subsubsection{\texorpdfstring{Detección de
\textbf{outliers}}{Detección de outliers}}\label{detecciuxf3n-de-outliers}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{outliers\_sigma3\_est }\OtherTok{\textless{}{-}}\NormalTok{ df\_Turismo }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Mes =} \FunctionTok{month}\NormalTok{(}\FunctionTok{as.Date}\NormalTok{(Periodo), }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{abbr =} \ConstantTok{TRUE}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(CCAA, Mes) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{es\_outlier\_sigma3 =} \FunctionTok{Sigma3\_est}\NormalTok{(Total)}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ccaa\_lista }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(outliers\_sigma3\_est}\SpecialCharTok{$}\NormalTok{CCAA)}

\ControlFlowTok{for}\NormalTok{ (cc }\ControlFlowTok{in}\NormalTok{ ccaa\_lista) \{}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ outliers\_sigma3\_est }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{filter}\NormalTok{(CCAA }\SpecialCharTok{==}\NormalTok{ cc) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(Periodo, Total)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{color =} \StringTok{"grey70"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ es\_outlier\_sigma3)) }\SpecialCharTok{+}
    \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"FALSE"} \OtherTok{=} \StringTok{"black"}\NormalTok{, }\StringTok{"TRUE"} \OtherTok{=} \StringTok{"red"}\NormalTok{)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \FunctionTok{paste}\NormalTok{(}\StringTok{"Detección estacional de outliers (3 sigma) {-}"}\NormalTok{, cc),}
      \AttributeTok{x =} \StringTok{"Periodo"}\NormalTok{, }
      \AttributeTok{y =} \StringTok{"Total"}\NormalTok{, }
      \AttributeTok{color =} \StringTok{"Outlier"}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-1.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-2.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-3.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-4.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-5.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-6.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-7.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-8.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-9.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-10.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-11.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-12.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-13.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-14.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-15.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-16.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-17.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-18.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-13-19.pdf}
...
\NormalTok{df\_Turismo }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Mes =} \FunctionTok{month}\NormalTok{(}\FunctionTok{as.Date}\NormalTok{(Periodo), }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{abbr =} \ConstantTok{TRUE}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(CCAA, Mes) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(Mes}\SpecialCharTok{==}\StringTok{\textquotesingle{}jul\textquotesingle{}}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{media =} \FunctionTok{mean}\NormalTok{(Total, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{varianza =} \FunctionTok{var}\NormalTok{(Total, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{mediana =} \FunctionTok{median}\NormalTok{(Total, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{desviacion\_tipica =} \FunctionTok{sd}\NormalTok{(Total, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{minimo =} \FunctionTok{min}\NormalTok{(Total, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{maximo =} \FunctionTok{max}\NormalTok{(Total, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{n\_observaciones =} \FunctionTok{n}\NormalTok{()}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{arrange}\NormalTok{(}\FunctionTok{desc}\NormalTok{(desviacion\_tipica))}
\end{Highlighting}
\end{Shaded}
...
## # A tibble: 19 x 9
## # Groups:   CCAA [19]
##    CCAA            Mes    media varianza mediana desviacion_tipica minimo maximo
##    <fct>           <ord>  <dbl>    <dbl>   <dbl>             <dbl>  <dbl>  <dbl>
##  1 Illes Balears   jul   4.24e7  8.28e13  4.27e7          9100956. 8.45e6 5.21e7
##  2 Cataluña        jul   3.41e7  6.21e13  3.50e7          7880467. 1.05e7 4.37e7
##  3 Canarias        jul   2.19e7  4.62e13  2.18e7          6799406. 4.96e6 3.05e7
##  4 Andalucía       jul   2.77e7  3.70e13  2.77e7          6086041. 1.36e7 3.59e7
##  5 Comunitat Vale~ jul   1.50e7  1.03e13  1.52e7          3208243. 6.34e6 1.92e7
##  6 Comunidad de M~ jul   9.23e6  9.29e12  9.11e6          3048000. 2.70e6 1.40e7
##  7 Galicia         jul   5.92e6  1.41e12  5.76e6          1185336. 3.49e6 7.84e6
##  8 País Vasco      jul   3.07e6  9.74e11  3.21e6           987078. 1.74e6 4.95e6
##  9 Castilla y León jul   4.62e6  4.79e11  4.52e6           692094. 2.63e6 5.73e6
## 10 Aragón          jul   2.78e6  2.89e11  2.58e6           537925. 1.79e6 3.59e6
## 11 Principado de ~ jul   2.53e6  2.48e11  2.45e6           497782. 1.66e6 3.33e6
## 12 Región de Murc~ jul   1.71e6  9.22e10  1.69e6           303717. 8.73e5 2.23e6
## 13 Cantabria       jul   2.22e6  8.74e10  2.17e6           295558. 1.82e6 2.70e6
## 14 Castilla - La ~ jul   1.95e6  5.81e10  1.95e6           241007. 1.15e6 2.28e6
## 15 Extremadura     jul   1.18e6  4.90e10  1.14e6           221419. 7.73e5 1.51e6
## 16 Comunidad Fora~ jul   1.01e6  4.06e10  1.00e6           201469. 6.42e5 1.30e6
## 17 La Rioja        jul   5.21e5  6.58e 9  5.22e5            81122. 3.10e5 6.93e5
## 18 Melilla         jul   2.94e4  5.61e 7  3.19e4             7489. 1.29e4 3.92e4
## 19 Ceuta           jul   4.40e4  5.29e 7  4.46e4             7272. 1.88e4 5.45e4
## # i 1 more variable: n_observaciones <int>
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{outliers\_hampel\_est }\OtherTok{\textless{}{-}}\NormalTok{ df\_Turismo }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Mes =} \FunctionTok{month}\NormalTok{(}\FunctionTok{as.Date}\NormalTok{(Periodo), }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{abbr =} \ConstantTok{TRUE}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(CCAA, Mes) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{es\_outlier\_hampel =} \FunctionTok{Hampel\_est}\NormalTok{(Total)}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ungroup}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ccaa\_lista }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(outliers\_hampel\_est}\SpecialCharTok{$}\NormalTok{CCAA)}

\ControlFlowTok{for}\NormalTok{ (cc }\ControlFlowTok{in}\NormalTok{ ccaa\_lista) \{}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ outliers\_hampel\_est }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{filter}\NormalTok{(CCAA }\SpecialCharTok{==}\NormalTok{ cc) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(Periodo, Total)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{color =} \StringTok{"grey70"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ es\_outlier\_hampel)) }\SpecialCharTok{+}
    \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"FALSE"} \OtherTok{=} \StringTok{"black"}\NormalTok{, }\StringTok{"TRUE"} \OtherTok{=} \StringTok{"red"}\NormalTok{)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \FunctionTok{paste}\NormalTok{(}\StringTok{"Detección estacional de outliers (Hampel) {-}"}\NormalTok{, cc),}
      \AttributeTok{x =} \StringTok{"Periodo"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Total"}\NormalTok{, }\AttributeTok{color =} \StringTok{"Outlier"}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{theme\_minimal}\NormalTok{()}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-1.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-2.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-3.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-4.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-5.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-6.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-7.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-8.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-9.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-10.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-11.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-12.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-13.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-14.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-15.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-16.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-17.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-18.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-16-19.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{outliers\_boxplot\_est }\OtherTok{\textless{}{-}}\NormalTok{ df\_Turismo }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Mes =} \FunctionTok{month}\NormalTok{(}\FunctionTok{as.Date}\NormalTok{(Periodo), }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{abbr =} \ConstantTok{TRUE}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}  \CommentTok{\# crea la columna Mes}
  \FunctionTok{group\_by}\NormalTok{(CCAA, Mes) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{es\_outlier\_boxplot =} \FunctionTok{Boxplot\_est}\NormalTok{(Total)}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ungroup}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ccaa\_lista }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(outliers\_boxplot\_est}\SpecialCharTok{$}\NormalTok{CCAA)}


\ControlFlowTok{for}\NormalTok{ (cc }\ControlFlowTok{in}\NormalTok{ ccaa\_lista) \{}
\NormalTok{  p }\OtherTok{\textless{}{-}}\NormalTok{ outliers\_boxplot\_est }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{filter}\NormalTok{(CCAA }\SpecialCharTok{==}\NormalTok{ cc) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(Periodo, Total)) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{color =} \StringTok{"grey70"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ es\_outlier\_boxplot)) }\SpecialCharTok{+}
    \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"FALSE"} \OtherTok{=} \StringTok{"black"}\NormalTok{, }\StringTok{"TRUE"} \OtherTok{=} \StringTok{"red"}\NormalTok{)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \FunctionTok{paste}\NormalTok{(}\StringTok{"Detección outliers (Boxplot) {-}"}\NormalTok{, cc),}
      \AttributeTok{x =} \StringTok{"Periodo"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Total"}\NormalTok{, }\AttributeTok{color =} \StringTok{"Outlier"}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{theme\_minimal}\NormalTok{()}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-1.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-2.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-3.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-4.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-5.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-6.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-7.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-8.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-9.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-10.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-11.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-12.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-13.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-14.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-15.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-16.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-17.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-18.pdf}
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-18-19.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df\_outliers }\OtherTok{\textless{}{-}}\NormalTok{ df\_Turismo }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Mes =} \FunctionTok{month}\NormalTok{(}\FunctionTok{as.Date}\NormalTok{(Periodo), }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{abbr =} \ConstantTok{TRUE}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(CCAA, Mes) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{out\_hampel  =} \FunctionTok{Hampel\_est}\NormalTok{(Total),}
    \AttributeTok{out\_boxplot =} \FunctionTok{Boxplot\_est}\NormalTok{(Total),}
    \AttributeTok{out\_sigma3  =} \FunctionTok{Sigma3\_est}\NormalTok{(Total)}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ungroup}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tabla\_outliers\_ccaa }\OtherTok{\textless{}{-}}\NormalTok{ df\_outliers }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(CCAA) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{n\_hampel  =} \FunctionTok{sum}\NormalTok{(out\_hampel,  }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{n\_boxplot =} \FunctionTok{sum}\NormalTok{(out\_boxplot, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{n\_sigma3  =} \FunctionTok{sum}\NormalTok{(out\_sigma3,  }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{arrange}\NormalTok{(}\FunctionTok{desc}\NormalTok{(n\_hampel))}

\NormalTok{tabla\_outliers\_ccaa}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/Gráfica de ajuste-1.pdf}
...
menores menores.
\includegraphics{Informe_Grupo_F_files/figure-latex/Gráfica de predicción buena-1.pdf}

\includegraphics{Informe_Grupo_F_files/figure-latex/Gráfica de predicción intermedia-1.pdf}

\includegraphics{Informe_Grupo_F_files/figure-latex/Gráfica de predicción mala-1.pdf}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-29-1.pdf}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-36-1.pdf}
...
\includegraphics{Informe_Grupo_F_files/figure-latex/unnamed-chunk-38-1.pdf}
