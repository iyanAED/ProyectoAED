...
\includegraphics[width=0.9\linewidth,height=0.3\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 1-1}

\includegraphics[width=0.9\linewidth,height=0.3\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 2-1}

\includegraphics[width=0.9\linewidth,height=0.3\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 3-1}
...
\emph{outlier}, la pregunta principal es qué hacer con ellos. Esta
pregunta no es sencilla, como se ha mencionado, hay métodos de detección
que no los clasifican como tales.
...
sugiere que este sector se recuperó de forma bastante rápida cuando la
situación sanitaria lo permitió.

Esto hace pensar que la pandemia simplemente puso una ``pausa'' al
turismo y tras ello la actividad en este sector continuó desarrollándose
de la misma forma que lo venía haciendo en los últimos años, aunque si
es cierto que el crecimiento se desaceleró ligeramente. Lo cual sugiere
que los datos de la pandemia no aportan ningún tipo de información
relevante.
...
Se pueden ver las diferentes gráficas de juste para cada comunidad, como
...
\includegraphics[width=0.9\linewidth,height=0.2\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 4-1}
...
\includegraphics[width=0.9\linewidth,height=0.2\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 5-1}

\includegraphics[width=0.9\linewidth,height=0.2\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 7-1}
...
\includegraphics[width=0.9\linewidth,height=0.2\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 8-1}
...
\includegraphics[width=0.9\linewidth,height=0.3\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 9-1}
...
\includegraphics[width=0.9\linewidth,height=0.2\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 10-1}
...
\includegraphics[width=0.9\linewidth,height=0.3\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 11-1}
...
\includegraphics[width=0.9\linewidth,height=0.4\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 12-1}
...
\includegraphics[width=0.9\linewidth,height=0.3\textheight]{Informe_Grupo_F_files/figure-latex/Gráfico 13-1}
