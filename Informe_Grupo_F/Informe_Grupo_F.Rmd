...
Tras la limpieza, se comprobó la ausencia de espacios en blanco y valores faltantes (NA) para asegurar la integridad del conjunto de datos. 
...
Al no detectarse incidencias, el dataset quedó listo para el análisis y se guardó en formato RData.#TODO ARREGLAR ERROR
