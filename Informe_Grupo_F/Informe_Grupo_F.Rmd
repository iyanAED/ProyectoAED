...
```{r Gráfico 1, echo=FALSE, out.height="30%", out.width="90%"}
...
```{r Gráfico 2, echo=FALSE, out.height="30%", out.width="90%"}
...
```{r Gráfico 3, echo=FALSE, out.height="30%", out.width="90%"}
...
```{r Gráfico 4, out.height="20%", out.width="90%"}
AnalisisBox[[2]]
```
...
```{r Gráfico 5, echo=FALSE, out.height="20%", out.width="90%"}
AnalisisBox[[18]]
```

```{r Gráfico 7, echo=FALSE, out.height="20%", out.width="90%"}
AnalisisBox[[13]]
```
...
```{r Gráfico 8, out.height="20%", out.width="90%"}
...
```{r Gráfico 9, out.height="30%", out.width="90%"}
...
```{r Gráfico 10, out.height="20%", out.width="90%"}
...
```{r Gráfico 11, out.height="30%", out.width="90%"}
...
```{r Imputación de los datos con las predicciones}
...
```{r Gráfico 12, echo=FALSE, out.height="40%", out.width="90%"}
...
```
```{r Gráfico 13, echo=FALSE, out.height="30%", out.width="90%"}
año_ref <- 2024
