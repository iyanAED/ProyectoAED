...
# Serie_completa: es la serie completa
# H: es el número de periodos en el futuro que se pued
Prediccion <- function(Serie, Serie_Completa, H){
  ...
  return(list(Prediccion=pred, 
              ...
              errores_predic=Errores(Serie_Completa[(length(Serie_Completa)-H):length(Serie_Completa)], pred$mean),
...
Esa fecha es el 14 del mes de marzo de 2020, como se produce amitad
