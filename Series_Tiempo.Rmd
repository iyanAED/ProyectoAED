...
También es necesario hacer predicciones y ver la calidad de estas.

```{r Predicciones}

Prediccion <- function(Serie, Modelo){
  pred <- predict(Modelo, n.ahead=12, prediction.interval=TRUE, level=0.95) 
  plot(Modelo, pred)
}
